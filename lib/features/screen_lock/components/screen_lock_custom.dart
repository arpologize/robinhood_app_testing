...
import 'key_pad_custom.dart';

///custom from lib 'package:flutter_screen_lock/flutter_screen_lock.dart'
class ScreenLockCustom extends StatefulWidget {
  /// Animated ScreenLock
  const ScreenLockCustom({
    super.key,
  ...
  @override
  State<ScreenLockCustom> createState() => _ScreenLockCustomState();
}

class _ScreenLockCustomState extends State<ScreenLockCustom> {
  ...
  @override
  void didUpdateWidget(covariant ScreenLockCustom oldWidget) {
